...
import { FormStyled, GroupStyled, H5Styled } from "./styled/contact-styled";
                ...
                <Row className="layout-space">
                    ...
                    <Col xs={12} lg={5}>
                        <GroupStyled>
                            ...
                            <p className="m-0">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</p>
                        </GroupStyled>
                        <GroupStyled>
                            <H5Styled>address</H5Styled>
                            <p className="m-0">18 Elhosary Street, Kafr El-Dawwar, Beheira Governorate, Egypt.</p>
                        </GroupStyled>
                        <GroupStyled>
                    ...
                    <Col xs={12} lg={7}>
                        ...
                        <p className="mb-5">We’d love to build something great together.</p>
                        <FormStyled>
                            ...
                            <DefaultInput required as="textarea" size="sm" placeholder="Type Your Message Here *" />
